...
class MarketService {
     ...
     */
    async getResourceInventory(ownerId, ownerType) {
        try {
     ...
     */
    async updateResourceInventory(ownerId, ownerType, resources, maxCapacity) {
        try {
     ...
     */
    async addResources(ownerId, ownerType, resources) {
        try {
     ...
     */
    async removeResources(ownerId, ownerType, resources) {
        try {
     ...
     */
    async transferResources(fromOwnerId, fromOwnerType, toOwnerId, toOwnerType, resources) {
        try {
     ...
     */
    async purchaseItem(listingId, buyerId, buyerType = "User") {
        try {
     ...
     */
    async createRewardTransaction(userId, rewards) {
        try {
            const now = new Date();
     ...
     */
    canAccessEconomicLayer(userTier, requiredLayer) {
